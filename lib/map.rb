class Map
  ...
  def init_tiles
    @a_grid << Tile.new('A1') << Tile.new('A2') << Tile.new('A3') << Tile.new('A4')
    @b_grid << Tile.new('B1') << Tile.new('B2') << Tile.new('B3') << Tile.new('B4')
    @c_grid << Tile.new('C1') << Tile.new('C2') << Tile.new('C3') << Tile.new('C4')
    @d_grid << Tile.new('D1') << Tile.new('D2') << Tile.new('D3') << Tile.new('D4')
  end
